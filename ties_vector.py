...
# 使用示例
model_path_list_pyra = ['/data/guoyufei21/ViT-B_PYRA_logs_weights_high_compression_rate/cifar100_lr-0.001_wd-0.0001_pyra_lr-3e-6/best_checkpoint.pth',
...
ties_merge_model_weights(model_path_list_pyra, f'best_checkpoint_0.pth', '/data/guoyufei21/base_model_pyra_high.pth', k=0.8, λ=1.0)
